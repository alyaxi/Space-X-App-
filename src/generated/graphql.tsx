...
export type MissionsInfoQuery = (
  ...
  & { launches?: Maybe<Array<Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'flight_number' | 'mission_id' | 'mission_name' | 'launch_year' | 'launch_success' | 'launch_date_local'>
  )>>> }
);

export type LauncheMissionDetailQueryVariables = Exact<{
  id: Scalars['String'];
}>;


export type LauncheMissionDetailQuery = (
  { __typename?: 'Query' }
  & { launch?: Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'flight_number' | 'details' | 'is_tentative' | 'launch_date_local' | 'launch_success' | 'launch_year' | 'mission_id' | 'mission_name' | 'upcoming'>
    & { launch_site?: Maybe<(
      { __typename?: 'LaunchSite' }
      & Pick<LaunchSite, 'site_id' | 'site_name_long' | 'site_name'>
    )>, rocket?: Maybe<(
      { __typename?: 'LaunchRocket' }
      & Pick<LaunchRocket, 'rocket_name' | 'rocket_type'>
    )>, links?: Maybe<(
      { __typename?: 'LaunchLinks' }
      & Pick<LaunchLinks, 'flickr_images' | 'article_link' | 'video_link'>
    )> }
  )> }
);
...
export const LauncheMissionDetailDocument = gql`
...
/**
 * __useLauncheMissionDetailQuery__
 *
 * To run a query within a React component, call `useLauncheMissionDetailQuery` and pass it any options that fit your needs.
 * When your component renders, `useLauncheMissionDetailQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useLauncheMissionDetailQuery(baseOptions: Apollo.QueryHookOptions<LauncheMissionDetailQuery, LauncheMissionDetailQueryVariables>) {
        return Apollo.useQuery<LauncheMissionDetailQuery, LauncheMissionDetailQueryVariables>(LauncheMissionDetailDocument, baseOptions);
      }
export function useLauncheMissionDetailLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LauncheMissionDetailQuery, LauncheMissionDetailQueryVariables>) {
          return Apollo.useLazyQuery<LauncheMissionDetailQuery, LauncheMissionDetailQueryVariables>(LauncheMissionDetailDocument, baseOptions);
        }
export type LauncheMissionDetailQueryHookResult = ReturnType<typeof useLauncheMissionDetailQuery>;
export type LauncheMissionDetailLazyQueryHookResult = ReturnType<typeof useLauncheMissionDetailLazyQuery>;
export type LauncheMissionDetailQueryResult = Apollo.QueryResult<LauncheMissionDetailQuery, LauncheMissionDetailQueryVariables>;